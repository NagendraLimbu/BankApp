...
/*controller register beans into spring containers but restController is for rest api controller and when we return instances spring will help to deserialize bydefault and parse to JSON format.*/
@RestController
@RequestMapping("/api")
